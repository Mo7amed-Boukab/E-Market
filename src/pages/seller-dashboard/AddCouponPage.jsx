...
import { ArrowLeft, Tag, Calendar, DollarSign, Percent, Hash, AlertCircle, ChevronDown } from 'lucide-react';
        ...
        <div className="space-y-6 pb-10">
            ...
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    ...
                    <p className="text-gray-500">Create a new discount coupon for your customers</p>
                </div>
            </div>
